...
namespace Leadping.OpenApiClient.PhoneCall.Item.Hangup
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.PhoneCall.Item.Hangup.HangupRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HangupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/phone-call/{callId}/hangup", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.PhoneCall.Item.Hangup.HangupRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HangupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/phone-call/{callId}/hangup", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Leadping.OpenApiClient.Models.PhoneCallResponse?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Leadping.OpenApiClient.Models.PhoneCallResponse> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.PhoneCall.Item.Hangup.HangupRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.PhoneCall.Item.Hangup.HangupRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.PhoneCall.Item.Hangup.HangupRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
