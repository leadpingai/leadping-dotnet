...
namespace Leadping.OpenApiClient.Notifications.Item.MarkRead
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Notifications.Item.MarkRead.MarkReadRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MarkReadRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/notifications/{id}/mark-read", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Notifications.Item.MarkRead.MarkReadRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MarkReadRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/notifications/{id}/mark-read", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.Notifications.Item.MarkRead.MarkReadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Notifications.Item.MarkRead.MarkReadRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Notifications.Item.MarkRead.MarkReadRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
