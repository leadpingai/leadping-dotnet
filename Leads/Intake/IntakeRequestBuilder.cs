...
namespace Leadping.OpenApiClient.Leads.Intake
{
    ...
    public partial class IntakeRequestBuilder : BaseRequestBuilder
    {
        ...
        public IntakeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leads/intake", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Leads.Intake.IntakeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IntakeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leads/intake", rawUrl)
        {
        }
        /// <summary>
