...
namespace Leadping.OpenApiClient.Leads.Item.WorkflowStatus
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Leads.Item.WorkflowStatus.WorkflowStatusRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Leadping.OpenApiClient.Models.AutomationWorkflowStatusResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Leadping.OpenApiClient.Models.AutomationWorkflowStatusResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.Leads.Item.WorkflowStatus.WorkflowStatusRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Leads.Item.WorkflowStatus.WorkflowStatusRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Leads.Item.WorkflowStatus.WorkflowStatusRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
