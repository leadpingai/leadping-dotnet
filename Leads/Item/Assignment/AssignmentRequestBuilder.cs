...
namespace Leadping.OpenApiClient.Leads.Item.Assignment
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Leads.Item.Assignment.AssignmentRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leads/{%2Did}/assignment", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Leads.Item.Assignment.AssignmentRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AssignmentRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/leads/{%2Did}/assignment", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <param name="body">Assigns an organization lead to an active organization member. A null user ID returns the lead to the unassigned queue.</param>
...
#nullable enable
        public async Task<global::Leadping.OpenApiClient.Models.LeadResponse?> PutAsync(global::Leadping.OpenApiClient.Models.LeadAssignmentRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Leadping.OpenApiClient.Models.LeadResponse> PutAsync(global::Leadping.OpenApiClient.Models.LeadAssignmentRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Leadping.OpenApiClient.Models.LeadAssignmentRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Leadping.OpenApiClient.Models.LeadAssignmentRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.Leads.Item.Assignment.AssignmentRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Leads.Item.Assignment.AssignmentRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Leads.Item.Assignment.AssignmentRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
