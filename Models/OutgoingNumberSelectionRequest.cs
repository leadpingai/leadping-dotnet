...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Models.OutgoingNumberSelectionRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.Models.OutgoingNumberSelectionRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Leadping.OpenApiClient.Models.OutgoingNumberSelectionRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Leadping.OpenApiClient.Models.OutgoingNumberSelectionRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "channel", n => { Channel = n.GetEnumValue<global::Leadping.OpenApiClient.Models.OutgoingNumberSelectionRequest_channel>(); } },
                { "conversationId", n => { ConversationId = n.GetStringValue(); } },
                { "leadId", n => { LeadId = n.GetStringValue(); } },
                { "recipientPhoneNumber", n => { RecipientPhoneNumber = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Leadping.OpenApiClient.Models.OutgoingNumberSelectionRequest_channel>("channel", Channel);
            writer.WriteStringValue("conversationId", ConversationId);
            writer.WriteStringValue("leadId", LeadId);
            writer.WriteStringValue("recipientPhoneNumber", RecipientPhoneNumber);
