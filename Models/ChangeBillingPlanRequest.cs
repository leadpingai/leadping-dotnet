...
namespace Leadping.OpenApiClient.Models
{
    ...
    public partial class ChangeBillingPlanRequest : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.Models.ChangeBillingPlanRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Leadping.OpenApiClient.Models.ChangeBillingPlanRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Leadping.OpenApiClient.Models.ChangeBillingPlanRequest();
        }
        /// <summary>
