...
namespace Leadping.OpenApiClient.Models
{
    ...
    public partial class BusinessDunningInfo : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>Date and time when this Leadping business dunning info was final cancellation.</summary>
        public DateTimeOffset? FinalCancellationAt { get; set; }
        /// <summary>Date and time when this Leadping business dunning info was grace period ends.</summary>
        public DateTimeOffset? GracePeriodEndsAt { get; set; }
        /// <summary>Current last failed invoice status for this Leadping business dunning info.</summary>
...
#nullable restore
        ...
        public string LastFailedInvoiceStatus { get; set; }
#endif
        /// <summary>Date and time when this Leadping business dunning info was last updated.</summary>
        public DateTimeOffset? LastUpdatedAt { get; set; }
        /// <summary>Date and time when the next retry is scheduled.</summary>
        public DateTimeOffset? NextRetryAt { get; set; }
        /// <summary>Date and time when this Leadping business dunning info was outbound restricted.</summary>
        public DateTimeOffset? OutboundRestrictedAt { get; set; }
        /// <summary>Date and time when this Leadping business dunning info was outbound suspended.</summary>
        public DateTimeOffset? OutboundSuspendedAt { get; set; }
        /// <summary>Date and time when this Leadping business dunning info was payment failed.</summary>
        public DateTimeOffset? PaymentFailedAt { get; set; }
        /// <summary>Total number of retry attempt records represented by this Leadping business dunning info.</summary>
        public int? RetryAttemptCount { get; set; }
        /// <summary>Current stage for this Leadping business dunning info.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
