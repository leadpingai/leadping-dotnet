...
#nullable restore
        ...
        public static global::Leadping.OpenApiClient.Models.PagedResultOfSuppressionEntryResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Leadping.OpenApiClient.Models.PagedResultOfSuppressionEntryResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "items", n => { Items = n.GetCollectionOfObjectValues<global::Leadping.OpenApiClient.Models.SuppressionEntryResponse>(global::Leadping.OpenApiClient.Models.SuppressionEntryResponse.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Leadping.OpenApiClient.Models.SuppressionEntryResponse>("items", Items);
