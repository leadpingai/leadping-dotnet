...
namespace Leadping.OpenApiClient.Models
{
    ...
    public partial class PagedResultOfBusinessTableRow : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Leadping.OpenApiClient.Models.BusinessTableRow>? Items { get; set; }
#nullable restore
#else
        public List<global::Leadping.OpenApiClient.Models.BusinessTableRow> Items { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Models.PagedResultOfBusinessTableRow"/> and sets the default values.
        /// </summary>
        ...
        public static global::Leadping.OpenApiClient.Models.PagedResultOfBusinessTableRow CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Leadping.OpenApiClient.Models.PagedResultOfBusinessTableRow();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "items", n => { Items = n.GetCollectionOfObjectValues<global::Leadping.OpenApiClient.Models.BusinessTableRow>(global::Leadping.OpenApiClient.Models.BusinessTableRow.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Leadping.OpenApiClient.Models.BusinessTableRow>("items", Items);
