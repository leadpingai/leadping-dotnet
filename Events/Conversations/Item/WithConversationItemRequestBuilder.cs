...
using Leadping.OpenApiClient.Events.Conversations.Item.Notes;
...
namespace Leadping.OpenApiClient.Events.Conversations.Item
{
    ...
    public partial class WithConversationItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Leadping.OpenApiClient.Events.Conversations.Item.Notes.NotesRequestBuilder Notes
        {
            get => new global::Leadping.OpenApiClient.Events.Conversations.Item.Notes.NotesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Events.Conversations.Item.WithConversationItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithConversationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/conversations/{conversationId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Events.Conversations.Item.WithConversationItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithConversationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/conversations/{conversationId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Events.Conversations.Item.WithConversationItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Events.Conversations.Item.WithConversationItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
