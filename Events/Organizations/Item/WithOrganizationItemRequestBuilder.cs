...
namespace Leadping.OpenApiClient.Events.Organizations.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithOrganizationItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/organizations/{organizationId}{?endAt*,startAt*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithOrganizationItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/organizations/{organizationId}{?endAt*,startAt*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Leadping.OpenApiClient.Models.PagedResultOfEventTableRow?> PostAsync(global::Leadping.OpenApiClient.Models.RequestDataOptions body, Action<RequestConfiguration<global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder.WithOrganizationItemRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Leadping.OpenApiClient.Models.PagedResultOfEventTableRow> PostAsync(global::Leadping.OpenApiClient.Models.RequestDataOptions body, Action<RequestConfiguration<global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder.WithOrganizationItemRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Leadping.OpenApiClient.Models.RequestDataOptions body, Action<RequestConfiguration<global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder.WithOrganizationItemRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Leadping.OpenApiClient.Models.RequestDataOptions body, Action<RequestConfiguration<global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder.WithOrganizationItemRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Events.Organizations.Item.WithOrganizationItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists event records for an organization with paging and filters so admins can review lead communication and automation events.
        /// </summary>
