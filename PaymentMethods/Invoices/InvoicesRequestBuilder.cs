...
#nullable restore
        ...
        public async Task<List<global::Leadping.OpenApiClient.Models.StripeInvoiceResponse>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::Leadping.OpenApiClient.Models.StripeInvoiceResponse>(requestInfo, global::Leadping.OpenApiClient.Models.StripeInvoiceResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
