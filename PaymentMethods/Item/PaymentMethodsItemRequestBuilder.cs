...
using Leadping.OpenApiClient.PaymentMethods.Item.Default;
...
namespace Leadping.OpenApiClient.PaymentMethods.Item
{
    ...
    public partial class PaymentMethodsItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Leadping.OpenApiClient.PaymentMethods.Item.Default.DefaultRequestBuilder Default
        {
            get => new global::Leadping.OpenApiClient.PaymentMethods.Item.Default.DefaultRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.PaymentMethods.Item.PaymentMethodsItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PaymentMethodsItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/payment-methods/{id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.PaymentMethods.Item.PaymentMethodsItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PaymentMethodsItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/payment-methods/{id}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Leadping.OpenApiClient.Models.StripePaymentMethodResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Leadping.OpenApiClient.Models.StripePaymentMethodResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.PaymentMethods.Item.PaymentMethodsItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.PaymentMethods.Item.PaymentMethodsItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
