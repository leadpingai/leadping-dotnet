...
namespace Leadping.OpenApiClient.PhoneNumbers.Item.Warmup
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.PhoneNumbers.Item.Warmup.WarmupRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WarmupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/phone-numbers/{phoneNumber%2Did}/warmup{?endDate*,startDate*,windowDays*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.PhoneNumbers.Item.Warmup.WarmupRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WarmupRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/phone-numbers/{phoneNumber%2Did}/warmup{?endDate*,startDate*,windowDays*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Leadping.OpenApiClient.PhoneNumbers.Item.Warmup.WarmupRequestBuilder.WarmupRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Leadping.OpenApiClient.PhoneNumbers.Item.Warmup.WarmupRequestBuilder.WarmupRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.PhoneNumbers.Item.Warmup.WarmupRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.PhoneNumbers.Item.Warmup.WarmupRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.PhoneNumbers.Item.Warmup.WarmupRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns warmup status for a phone number, including limits and recent events used for delivery pacing.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WarmupRequestBuilderGetQueryParameters 
        {
