...
namespace Leadping.OpenApiClient.Automations.Item.Runs.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Automations.Item.Runs.Item.WithRunItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRunItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/automations/{id}/runs/{runId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Automations.Item.Runs.Item.WithRunItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithRunItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/automations/{id}/runs/{runId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Automations.Item.Runs.Item.WithRunItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Automations.Item.Runs.Item.WithRunItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
