...
using Leadping.OpenApiClient.Automations.Item.Runs.Item;
    ...
    public partial class RunsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Leadping.OpenApiClient.Automations.Item.Runs.Item.WithRunItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Leadping.OpenApiClient.Automations.Item.Runs.Item.WithRunItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Automations.Item.Runs.RunsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RunsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/automations/{id}/runs", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Automations.Item.Runs.RunsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public RunsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/automations/{id}/runs", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.Automations.Item.Runs.RunsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Automations.Item.Runs.RunsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Automations.Item.Runs.RunsRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
