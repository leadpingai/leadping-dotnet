...
namespace Leadping.OpenApiClient.Organizations.Me.Membership
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Organizations.Me.Membership.MembershipRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MembershipRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/organizations/me/membership", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Leadping.OpenApiClient.Organizations.Me.Membership.MembershipRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MembershipRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/organizations/me/membership", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Leadping.OpenApiClient.Organizations.Me.Membership.MembershipRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Leadping.OpenApiClient.Organizations.Me.Membership.MembershipRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Leadping.OpenApiClient.Organizations.Me.Membership.MembershipRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
